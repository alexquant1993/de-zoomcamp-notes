...
class JsonKStreamJoinsTest {
    ...
    // create topology and set application properties
    ...
    public void setup() {
        ...
        // create input and output test topics with the corresponding Serdes
    ...
    // test case for join functionality
    @Test
    public void testIfJoinWorksOnSameDropOffPickupLocationId() {
        ...
        // pipe input data to the corresponding topics
        ...
        // assert that an output was produced and read successfully
    ...
    // clean up the TopologyTestDriver instance
    @AfterAll
