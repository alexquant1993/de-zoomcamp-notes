...
BUCKET = os.environ.get("GCP_GCS_BUCKET", "dtc_data_lake_dtc-data-engineering-377412")
...
def web_to_gcs(year, service):
    for i in range(12):
        ...
        df = pd.read_csv(request_url, engine='python')
        ...
        df.to_parquet(file_name, engine="auto", index=False)
